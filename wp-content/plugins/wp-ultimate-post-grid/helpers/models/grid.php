...
class WPUPG_Grid {
    ...
    private $dynamically_generated = false;
    ...
    public function regenerate()
    {
        ...
        $this->dynamically_generated = true;
    ...
    {        
        // No cache mode.
        if ( false === $this->dynamically_generated && WPUltimatePostGrid::option( 'use_cache', '1' ) !== '1' ) {
            $this->regenerate();
        }
