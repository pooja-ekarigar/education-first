                ...
                array(
                    ...
                    'fields' => array(
                        array(
                            'type' => 'toggle',
                            'name' => 'use_cache',
                            'label' => __('Cache the Grid', 'wp-ultimate-post-grid'),
                            'description' => __( 'Cache the grid to improve load times. Disable to use the grid with WPML.', 'wp-ultimate-post-grid' ),
                            'default' => '1',
                        ),
                        array(
                            'type' => 'toggle',
