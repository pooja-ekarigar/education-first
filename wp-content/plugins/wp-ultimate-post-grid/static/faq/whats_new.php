<div class="changelog">
    <div>
        <p class="about-description">We keep working on WP Ultimate Post Grid. Find out what's new in our latest version.</p>
    </div>
    ...
    <div class="feature-section col two-col">
        <div class="col-1">
            <h3>WP Ultimate Post Grid 2.8</h3>
            <ul>
        ...
        <div class="col-2 last-feature">
            <h3>WP Ultimate Post Grid Premium 2.8</h3>
            <ul>
                <li>Feature: Dynamic filter by date</li>
                <li>Feature: Dynamic grid filtering applies to filter shortcode as well</li>
            </ul>
        </div>
    </div>
    ...
    <div>
        ...
        <h4>WP Ultimate Post Grid 2.7</h4>
        <ul>
        ...
        <h4>WP Ultimate Post Grid Premium 2.7</h4>
        <ul>
            <li>Feature: Hook to manually set the dropdown filter options</li>
            <li>Fix: Problem with the Post Taxonomy Terms block in the Template Editor</li>
        </ul>

        <h4>WP Ultimate Post Grid 2.6</h4>
        <ul>
        ...
        <h4>WP Ultimate Post Grid Premium 2.6</h4>
        <ul>
            <li>Feature: Dynamic limit by currently logged in user</li>
        </ul>

        <h4>Premium Plugin 2.5</h4>
        <ul>
            <li>Feature: Offset items in the grid</li>
            <li>Feature: Limit category grid dynamically</li>
        </ul>
        ...
        <ul>
            <li>Feature: Limit terms in category grid</li>
            <li>Improvement: Show empty terms in limit items dropdown</li>
            <li>Improvement: Hide pagination when using search filter</li>
            <li>Fix: Prevent grid refreshing multiple times when filtering</li>
            <li>Fix: Prevent double loading of items with load on filter</li>
        </ul>
        ...
        <ul>
            <li>Feature: Combined Text &amp; Isotope filter type</li>
            <li>Feature: Combined Text &amp; Dropdown filter type</li>
        </ul>
        ...
        <ul>
            <li>Feature: Ability to pre filter the grid using shortcode attributes</li>
        </ul>
        ...
        <h4>Premium Plugin 2.1</h4>
        <ul>
            <li>Feature: Filter grid by text</li>
            <li>Feature: Show term post count in filters</li>
            <li>Feature: Dynamically include or exclude current post/page ID</li>
        </ul>
        <h4>Core Plugin 2.1</h4>
        <ul>
        ...
        <ul>
            <li>Feature: Create grid consisting of categories or taxonomy terms</li>
            <li>Feature: Ability to change labels for dropdown filter</li>
            <li>Improvement: Add image width and height attributes when using fixed image sizes</li>
            <li>Improvement: Dynamically limit shortcode with post IDs</li>
            <li>Fix: Don't clean post content HTML when there is no cut off set</li>
        </ul>
        ...
        <h4>Premium Plugin 1.9</h4>
        <ul>
            <li>Feature: Exclude specific terms from filter</li>
            <li>Improvement: Dropdown filters will be displayed in order of selection</li>
            <li>Setting: Hide search in single select dropdown</li>
            <li>Fix: Better loading of new posts when filtering infinite scroll grids</li>
            <li>Fix: Infinite loop problem when dropdown taxonomy was deleted</li>
            <li>Fix: Cut-off problem with HTML code</li>
        </ul>
        <h4>Core Plugin 1.9</h4>
        <ul>
