...
function bootstrap_blog_widgets_init() {
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Widget Second', 'bootstrap-blog' ),
		'id'            => 'footer-2',
		'description'   => '',
		'before_widget' => '<aside id="%1$s" class="col-md-8">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h5 class="widget-title">',
		'after_title'   => '</h5>',
	) );
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Widget Third', 'bootstrap-blog' ),
		'id'            => 'footer-3',
		'description'   => '',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Widget Four', 'bootstrap-blog' ),
		'id'            => 'footer-4',
		'description'   => '',
		'before_widget' => '<aside id="%1$s" class="col-md-4">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h5 class="widget-title">',
		'after_title'   => '</h5>',
	) );
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Header Widget', 'bootstrap-blog' ),
		'id'            => 'header-widget',
		'description'   => '',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
