...
<header>
	...
	<section style=""  class="main-nav nav-one <?php if( $menu_sticky ) echo ' sticky-header'; ?>">
		<div class="container">
			<nav class="navbar">
		      	<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
			        ...
			        <span class="icon-bar"></span>
					  ...
					  <a class="navbar-brand" href="#"><img style="" class="img-responsive" src="http://ekarigarclients.com/education-first/wp-content/uploads/2018/11/logo_p.jpg" /></a>
				...
				<table class="social_icon"><tr>
							<td><img src="http://ekarigarclients.com/education-first/wp-content/uploads/2018/11/twi.png" /></td>
							<td><img src="http://ekarigarclients.com/education-first/wp-content/uploads/2018/11/insta.png" /></td>
							<td><img src="http://ekarigarclients.com/education-first/wp-content/uploads/2018/11/fb.png" /></td>
						</tr></table>
 ...
 <input id="search-input" type="search" class="search-input" placeholder="Search …" value="" name="s" title="Search for:" />
   <input type="submit" class="search-submit" value="Search" />
	...
	<!--<img style="width:100%;margin-top: -1px;" src="http://ekarigarclients.com/education-first/wp-content/uploads/2018/11/shadow.png" />-->
</header>